...
export default function Home() {
  ...
  return (
    <div className="md:w-9/12 md:mx-auto px-6">
      <h1 className="mt-12 text-4xl tracking-wide font-black text-blue-950 text-center mb-8">
        Contact Me
      </h1>
      ...
      <div className="md:grid md:grid-cols-2 md:gap-4">
        <div className="md:w-1/2">
          ...
          <div className="font-semibold text-gray-950 pr-6">
            ...
            <h4 className="text-3xl mb-2 font-semibold text-blue-800">
              Address
            </h4>

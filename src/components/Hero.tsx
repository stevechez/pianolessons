				...
				<div className="relative flex flex-col items-start w-full max-w-xl px-4 mx-auto md:px-0 lg:px-8 lg:max-w-screen-xl">
					<div className="mb-16 lg:my-40 lg:max-w-lg lg:pr-5">
						...
						<p className="mb-5 text-xl text-gray-300 pr-4 md:text-2xl">
							I specializing in teaching students how to play by ear. Unlike
							traditional piano instruction that relies heavily on sheet music,
							my approach is based on developing listening skills, a natural
							sense of rhythm, and the ability to improvise.
						</p>
